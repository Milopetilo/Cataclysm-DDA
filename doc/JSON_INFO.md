...
| `starts`          | (_optional_) This entry becomes active after this many days multiplied by the evolution scaling factor.  Specified using time units.
| `ends`            | (_optional_) This entry becomes inactive after this many days multiplied by the evolution scaling factor.  Specified using time units.
